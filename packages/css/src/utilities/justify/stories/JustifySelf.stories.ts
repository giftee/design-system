...
export default {
  ...meta,
  title: 'Utility/Justify/JustifySelf',
};
...
<div class="ab-grid ab-gap-8">
  <div class="ab-grid ab-justify-items-stretch ab-grid-cols-3 ab-gap-8 ab-border">
    ...
    <div class="ab-justify-self-auto ab-border ab-bg-rest-secondary">02(auto)</div>
  ...
  <div class="ab-grid ab-justify-items-stretch ab-grid-cols-3 ab-gap-8 ab-border">
    <div class="ab-border ab-bg-rest-secondary">01</div>
    <div class="ab-justify-self-start ab-border ab-bg-rest-secondary">02(start)</div>
    <div class="ab-border ab-bg-rest-secondary">03</div>
    <div class="ab-border ab-bg-rest-secondary">04</div>
    <div class="ab-border ab-bg-rest-secondary">05</div>
    <div class="ab-border ab-bg-rest-secondary">06</div>
  ...
  <div class="ab-grid ab-justify-items-stretch ab-grid-cols-3 ab-gap-8 ab-border">
    <div class="ab-border ab-bg-rest-secondary">01</div>
    <div class="ab-justify-self-end ab-border ab-bg-rest-secondary">02(end)</div>
    <div class="ab-border ab-bg-rest-secondary">03</div>
    <div class="ab-border ab-bg-rest-secondary">04</div>
    <div class="ab-border ab-bg-rest-secondary">05</div>
    <div class="ab-border ab-bg-rest-secondary">06</div>
  ...
  <div class="ab-grid ab-justify-items-stretch ab-grid-cols-3 ab-gap-8 ab-border">
    <div class="ab-border ab-bg-rest-secondary">01</div>
    <div class="ab-justify-self-center ab-border ab-bg-rest-secondary">02(center)</div>
    <div class="ab-border ab-bg-rest-secondary">03</div>
    <div class="ab-border ab-bg-rest-secondary">04</div>
    <div class="ab-border ab-bg-rest-secondary">05</div>
    <div class="ab-border ab-bg-rest-secondary">06</div>
