...
export default {
  ...meta,
  title: 'Utility/Grid/GridTemplateRows',
};

export const GridTemplateRows: Story = {
  render: (_args) => {
    return `
<div class="ab-grid ab-grid-flow-col ab-grid-rows-4 ab-gap-4 ab-border">
...
<div class="ab-grid ab-grid-flow-col ab-grid-rows-none ab-gap-4 ab-border ab-mt-12">
  <div class="ab-border ab-bg-rest-secondary">01</div>
  <div class="ab-border ab-bg-rest-secondary">02</div>
  <div class="ab-border ab-bg-rest-secondary">03</div>
</div>
